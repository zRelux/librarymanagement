...
public class DatabaseLibri extends JPanel {
	 ...
	 */
	public DatabaseLibri() {																	//firma del metodo
	...
	private void inizialize() {																	//firma del metodo		
		...
		txtFiltra.setToolTipText("Cerca Libri");												//imposto il testo di hover																
		...
		btnCambia.addActionListener(new ActionListener() {										//aggiunta dell'action listener
			public void actionPerformed(ActionEvent e) {
				Database.cambia(1);																//cambia il database visibile
				DatabaseIscritti.refresh();														//e refresha la tabella
			}
		});
		btnCambia.setToolTipText("Cambia Database");											//modifica del testo di hover
		
		JLabel lblDatabaseIscritti = new JLabel("Database Libri");								//creazione della label
	...
	public static void refresh() {
		String query = "select * from Libri";											//creo la query da eseguire
